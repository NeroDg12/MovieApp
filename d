  useEffect(()=>{
    ...
    const res = axios.get(" http://www.omdbapi.com/?i=tt3896198&apikey=65159faa")
      setMovie(res.data)
  },[])
  ...
  {movie.map((datas) =>(
    <li key={datas.imdbID}>
        <MovieCard title={datas.Title} year={datas.Year}/>
    </li>
  ))}
    ...
    <div className=' mx-auto bg-white rounded-lg shadow-l'>
